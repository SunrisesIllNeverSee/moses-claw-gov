...
Environment:
  ...
  BLIND_REVIEWER_ENABLED — set to "1" to forward adversarial review results to external reviewer
  BLIND_REVIEWER_URL     — endpoint URL for external blind reviewer (any provider)
